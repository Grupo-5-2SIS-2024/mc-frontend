...
async function atualizarGraficoRosca(filtros = {}) {
    const url = 'http://localhost:8080/mc/consultas/percentagem-concluidos';
    try {
...
async function atualizarGraficoBarraHorizontal(filtros = {}) {
    const url = 'http://localhost:8080/mc/consultas/altas-ultimos-seis-meses'; // URL do endpoint
...
async function atualizarGraficoBarraDePe(filtros = {}) {
    ...
    const url = 'http://localhost:8080/mc/consultas/horarios-ultimos-seis-meses';
    try {
        const dados = await fetchDados(url, filtros);
...
async function atualizarGraficoLinhaFidelizacao(filtros = {}) {
    const url = 'http://localhost:8080/mc/pacientes/conversoes-ultimos-seis-meses';
    try {
        const dados = await fetchDados(url, filtros);
...
async function buscarTabela(filtros = {}) {
    ...
    try {
        ...
        const resposta = await fetch("http://localhost:8080/mc/consultas/agendamentosProximos");
        if (!resposta.ok) {
...
async function preencherCamposDeFiltro() {
    const medicos = await fetchDados('http://localhost:8080/mc/medicos');
    const pacientes = await fetchDados('http://localhost:8080/mc/pacientes');
    const status = await fetchDados('http://localhost:8080/mc/statusConsultas');
    const areas = await fetchDados('http://localhost:8080/mc/especificacoes');
