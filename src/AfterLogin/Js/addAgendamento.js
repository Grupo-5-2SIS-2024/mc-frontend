...
async function buscarPacientesEMedicos() {
    ...
    try {
        ...
        const respostaMedicos = await fetch("http://mc/medicos");
...
async function agendarConsulta() {
    ...
    try {
        const respostaEspec = await fetch("http://mc/medicos");
        if (!respostaEspec.ok) {
        ...
        const respostaCadastro = await fetch("http://mc/consultas", {
            method: "POST",
        ...
        if (recorrente) {
            ...
            for (let i = 1; i <= 30; i++) {
                ...
                const respostaNovaConsulta = await fetch("http://mc/consultas", {
                    method: "POST",
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const resposta = await fetch(`http://mc/consultas/${idConsulta}`, {
                        method: 'PUT',
...
async function alterarConsulta(idConsulta) {
    ...
    try {
        ...
        const [medicos, pacientes, especializacoes] = await Promise.all([
            fetch("http://mc/medicos").then(res => res.json()),
            fetch("http://mc/pacientes").then(res => res.json()),
            fetch("http://mc/especificacoes").then(res => res.json())
        ]);
...
async function BaixarExcelGeral() {
    try {
        const resposta = await fetch(`http://mc/consultas/export/csv`, {
            method: 'GET',
            headers: {
                "Accept": "text/csv" 
            }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const resposta = await fetch(`http://mc/consultas/${ultimaConsulta.id}`, {
                        method: 'DELETE',
                        headers: {
                            "Content-type": "application/json; charset=UTF-8",
                            "Accept": "application/json"
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const resposta = await fetch(`http://mc/consultas/${consultaId}`, {
                        method: 'DELETE',
                        headers: {
                            "Content-type": "application/json; charset=UTF-8",
                            "Accept": "application/json"
