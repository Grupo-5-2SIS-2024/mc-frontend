// Inputs Especiais
    ...
    async function buscarValores(id) {
        ...
        const pictureImage = document.querySelector(".picture__image");
            ...
            const response = await fetch(`http://mc/medicos/${id}`);
            if (!response.ok) {
    ...
    async function carregarEspecificacoes() {
        try {
            const response = await fetch("http://mc/especificacoes");
            if (!response.ok) {
    ...
    async function atualizarColaborador() {
        ...
        if (validarCadastro()) {
            ...
            try {
                const respostaAtualizacao = await fetch(`http://mc/medicos/${id}`, {
                    method: "PUT",
